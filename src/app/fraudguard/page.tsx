        ...
        <header className="mb-12 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-3 py-1.5 text-xs font-medium text-ink-tertiary border border-border rounded-full hover:border-ink-tertiary transition-colors min-h-[36px]"
            >
